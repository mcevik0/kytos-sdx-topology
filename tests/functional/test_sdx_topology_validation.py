...
def test_name_required(valid_data):
    """ test should_fail_due_to_missing_name_attribute_on_payload """
    del valid_data["payload"]["name"]
...
def test_additional_properties(valid_data):
    """ test should_fail_due_to_additional_properties_on_payload """
    valid_data["payload"]["active"] = True
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_id_pattern(valid_data):
    """ test should_fail_due_to_invalid_id_on_payload """
    valid_data["payload"]["id"] = "sdx:topology:amlight.net"
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_name_pattern(valid_data):
    """ test should_fail_due_to_invalid_name_on_payload """
    valid_data["payload"]["name"] = "Amlight1"
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_version_type(valid_data):
    """ test should_fail_due_to_invalid_version_type_on_payload """
    valid_data["payload"]["version"] = "2"
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_time(valid_data):
    """ test should_fail_due_to_invalid_date_time_on_payload """
    valid_data["payload"]["timestamp"] = "2021-12-31 21:19:40Z"
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_node_required(valid_data):
    """ test should_fail_due_to_missing_nodes_attribute_on_payload """
    del valid_data["payload"]["nodes"]
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_empty_node_array(valid_data):
    """ test should_fail_due_to_empty_node_array_on_payload """
    valid_data["payload"]["nodes"] = []
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_node_additional_properties(valid_data):
    """ test should_fail_due_to_additional_properties_on_payload """
    valid_data["payload"]["nodes"][0]["active_node"] = 1
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_node_id_pattern(valid_data):
    """ test should_fail_due_to_invalid_node_id_on_payload """
    valid_data["payload"]["nodes"][0]["id"] = 'sdx:node:amlight.net:Ampath1'
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_node_name_required(valid_data):
    """ test should_fail_due_to_missing_node_name_attribute_on_payload """
    del valid_data["payload"]["nodes"][0]["name"]
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_node_name_pattern(valid_data):
    """ test should_fail_due_to_invalid_name_on_payload """
    valid_data["payload"]["nodes"][0]["name"] = 'Ampath1$'
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_empty_node_port_array(valid_data):
    """ test should_fail_due_to_empty_node_port_array_on_payload """
    valid_data["payload"]["nodes"][0]["ports"] = []
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_node_port_additional_properties(valid_data):
    """ test should_fail_due_to_additional_properties_on_node_port_payload """
    valid_data["payload"]["nodes"][0]["ports"][0]["active_node_port"] = 1
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_node_port_id_pattern(valid_data):
    """ test should_fail_due_to_invalid_node_port_id_on_payload """
    valid_data["payload"]["nodes"][0]["ports"][0]["id"] = \
...
def test_node_port_name_required(valid_data):
    """ test should_fail_due_to_missing_node_port_name_attribute_on_payload """
    del valid_data["payload"]["nodes"][0]["ports"][0]['name']
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_node_port_name_pattern(valid_data):
    """ test should_fail_due_to_invalid_node_port_name_on_payload """
    valid_data["payload"]["nodes"][0]["ports"][0]["name"] = 'Ampath1$'
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_node_port_type_pattern(valid_data):
    """ test should_fail_due_to_invalid_node_port_type_on_payload """
    valid_data["payload"]["nodes"][0]["ports"][0]["type"] = "200GE"
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_node_port_status_pattern(valid_data):
    """ test should_fail_due_to_invalid_nde_port_status_on_payload """
    valid_data["payload"]["nodes"][0]["ports"][0]["status"] = "unknow"
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_node_port_state_pattern(valid_data):
    """ test should_fail_due_to_invalid_node_port_state_on_payload """
    valid_data["payload"]["nodes"][0]["ports"][0]["state"] = "unknow"
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_empty_link_array(valid_data):
    """ test should_fail_due_to_empty_link_array_on_payload """
    valid_data["payload"]["links"] = []
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_link_additional_properties(valid_data):
    """ test should_fail_due_to_link_additional_properties_on_payload """
    valid_data["payload"]["links"][0]["active_link"] = 1
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_link_id_pattern(valid_data):
    """ test should_fail_due_to_link_invalid_id_on_payload """
    valid_data["payload"]["links"][0]["id"] = \
...
def test_link_name_required(valid_data):
    """ test should_fail_due_to_link_missing_name_attribute_on_payload """
    del valid_data["payload"]["links"][0]['name']
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_link_name_pattern(valid_data):
    """ test should_fail_due_to_invalid_name_on_payload """
    valid_data["payload"]["links"][0]["name"] = 'Ampath1$'
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_empty_link_port_array(valid_data):
    """ test should_fail_due_to_empty_link_port_array_on_payload """
    valid_data["payload"]["links"][0]["ports"] = []
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_link_port_pattern(valid_data):
    """ test should_fail_due_to_invalid_port_pattern_on_payload """
    valid_data["payload"]["links"][0]["ports"][0] = \
        'sdx:port:amlight.net:Ampath1:1'
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
...
def test_link_type_pattern(valid_data):
    """ test should_fail_due_to_invalid_type_on_payload """
    valid_data["payload"]["links"][0]["type"] = "extra"
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_link_bandwidth_out_range(valid_data):
    """ test should_fail_due_to_bandwidth_out_of_range_on_payload """
    valid_data["payload"]["links"][0]["bandwidth"] = 0
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_link_residual_out_range(valid_data):
    """ test should_fail_due_to_residual_out_of_range_on_payload """
    valid_data["payload"]["links"][0]["residual_bandwidth"] = 500
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_link_latency_out_range(valid_data):
    """ test should_fail_due_to_latency_out_of_range_on_payload """
    valid_data["payload"]["links"][0]["latency"] = 125000000000
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_link_packet_loss_out_range(valid_data):
    """ test should_fail_due_to_bandwidth_out_of_range_on_payload """
    valid_data["payload"]["links"][0]["packet_loss"] = 500
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_link_status_pattern(valid_data):
    """ test should_fail_due_to_invalid_status_on_payload """
    valid_data["payload"]["links"][0]["status"] = "unknow"
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
...
def test_state_pattern(valid_data):
    """ test should_fail_due_to_invalid_state_on_payload """
    valid_data["payload"]["links"][0]["state"] = "unknow"
    response = requests.post(
            url=valid_data["url"], data=json.dumps(valid_data["payload"]),
            headers=valid_data["headers"])
    assert response.status_code == 400
